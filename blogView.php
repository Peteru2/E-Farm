		...
		?>
			...
			<section id="main" class="wrapper">
				...
				<div class="inner">
					...
					<form method = "post" action ="bsearch.php" class="navbar-form navbar-left searchformmargin"  role="search" >
					<!-- <div class="form-group"> -->
					<p>Please search for a blog or comment through the username</p>

                        <input type="text" name="search" class="form-control searchform" placeholder="Enter the username">
                        <button type="submit" name="submi" class="searchbutton form-control"><span class="glyphicon glyphicon-search "></span></button>
					<!-- </div> -->
                </form>
					...
					<div class="box">
						...
						?>
							<div class="con darker">
								...
								<br>
								<?= $row1['comment']; ?>
								<span class="time-right"><?= $row1['commentTime']; ?></span>
							</div>
